...
const BoardPage = () => {
  ...
  const {
    ...
    isConnecting, reactShapes, konvaShapes, stageFrames, images, connections, tempDrawingShape, selectedNodeIds, stageInstance, tempDimensions,
    ...
    setIsConnecting, setReactShapes, setKonvaShapes, setStageFrames, setImages, setConnections, setTempDrawingShape, setSelectedNodeIds, setStageInstance,
    ...
    <>
      <div className="relative w-screen h-screen bg-slate-50">
        ...
        <StageComponent
          ...
          tempDrawingShape={tempDrawingShape} // RESTORED
